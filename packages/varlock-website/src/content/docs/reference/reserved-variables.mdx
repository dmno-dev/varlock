...
Controls whether [`varlock/auto-load`](/integrations/javascript/) and [`varlock run`](/reference/cli/load-and-run/#run) boot from a [frozen env file](/guides/frozen-env/) produced by [`varlock freeze`](/reference/cli/project/#freeze):
