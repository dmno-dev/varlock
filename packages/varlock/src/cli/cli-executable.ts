...
import { commandSpec as sessionsCommandSpec } from './commands/sessions.command-spec';
...
subCommands.set('sessions', lazy(async () => (await import('./commands/sessions.command')).commandFn, sessionsCommandSpec));
