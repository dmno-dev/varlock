...
| Option | Meaning |
|---|---|
| `username` | Static username. Mutually exclusive with `usernameItem`; both omitted = empty username. |
| `usernameItem` | Item holding the username, when it is itself managed config. |
