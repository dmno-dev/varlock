...
export function resolveTsGenOptions(options: Record<string, any> = {}): Required<TsGenOptions> {
  return {
...
export async function generateTsTypesSrc(items: Array<TypeGenItemInfo>, options: TsGenOptions = {}) {
