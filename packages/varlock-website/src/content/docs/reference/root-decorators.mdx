...
- For **local dev**, the blob is injected as plaintext unless `_VARLOCK_ENV_KEY` is set in your environment (see [Local development](/guides/encrypted-deployments/#local-development))
