...
| --- | --- | --- |
| Python | `@generatePythonTypes` | `from env_types import ENV, SENSITIVE_KEYS` |
| Rust | `@generateRustTypes` | `env::load()` |
| Go | `@generateGoTypes` | `env.Load()` |
| PHP | `@generatePhpTypes` | `Env::load()` |
