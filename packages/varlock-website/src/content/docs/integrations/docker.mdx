...
That is a weaker seal, since the payload lives in platform config rather than inside the release. See [carrying the payload in an env var](/guides/frozen-env/#carrying-the-payload-in-an-env-var-instead) for the full comparison.
