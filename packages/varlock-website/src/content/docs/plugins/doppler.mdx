...
- `cacheTtl` (optional): cache resolved values for the specified duration (e.g. `"5m"`, `"1h"`, `"1d"`, or `0` for forever). For cache mode behavior and CLI cache controls, see the [Caching guide](/guides/caching/).
