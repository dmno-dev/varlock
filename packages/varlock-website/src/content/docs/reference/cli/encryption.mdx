...
The scan recognizes the conventional ways of reading env vars (`process.env.KEY`, `import.meta.env.KEY`, `os.environ["KEY"]`, and the equivalents in Go, Ruby, PHP, Rust, Java and C#), in files whose extension it knows.
