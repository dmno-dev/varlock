...
Imports other `.env` file(s) - useful for sharing config across monorepos and splitting up large schemas.
...
See the [@import guide](/guides/import/) for more details and advanced usage.
