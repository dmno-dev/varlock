...
<CardGrid>
  <LinkCard title="Box (ascii.dev)" href="/sandboxes/box-ascii/" description="Broker box reachable over public IPv4 or their HTTPS ingress; agent boxes created with --no-env" />
