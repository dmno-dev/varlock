...
Our [AWS Secrets Manager](https://aws.amazon.com/secrets-manager/) plugin enables secure loading of secrets from AWS Secrets Manager and parameters from [AWS Systems Manager Parameter Store](https://aws.amazon.com/systems-manager/features/#Parameter_Store) using declarative instructions within your `.env` files.
