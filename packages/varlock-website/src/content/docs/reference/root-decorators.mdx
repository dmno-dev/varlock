...
Varlock generates code from your schema via per-language decorators — see the [Code generation guide](/guides/code-generation/) for the full picture. Add one decorator per output file you want:
