...
Adjust binds for your distro layout and tools (such as `node` or agent binaries under `/home`). Prefer Fence if you want packaged agent templates and domain allowlisting without maintaining a long `bwrap` line.
