...
export const ROOT_DECORATORS: Array<DecoratorInfo> = [
  ...
  },
  {
    ...
    documentation: 'Example: `# @generatePythonEnv(path=./env.py)`.',
  ...
  },
  {
    ...
    documentation: 'Example: `# @generateRustEnv(path=./src/env.rs)`.',
  ...
  },
  {
    ...
    documentation: 'Example: `# @generateGoEnv(path=./env/env.go)`. The package name defaults to the output directory; override with `package=`.',
  ...
  },
  {
    ...
    documentation: 'Example: `# @generatePhpEnv(path=./Env.php)`. For Composer/PSR-4, set `namespace=` and/or `class=` (default: global `Env`).',
