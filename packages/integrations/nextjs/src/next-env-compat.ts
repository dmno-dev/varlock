...
export function loadEnvConfig(
  ...
  const varlockInternalEnv = {
    __VARLOCK_ENV: JSON.stringify(varlockLoadedEnv),
    __VARLOCK_SENSITIVE_VALS: JSON.stringify(sensitiveValues),
    __VARLOCK_SENSITIVE_KEYS: JSON.stringify(sensitiveKeys),
  };

  combinedEnv = { ...initialEnv, ...parsedEnv, ...varlockInternalEnv };
