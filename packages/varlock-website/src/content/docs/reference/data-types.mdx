...
- `matches` (string|RegExp): Regular expression pattern to match. Use `/pattern/flags` syntax, or `regex("pattern", "flags")` when the pattern contains a comma or space (see [regex-like strings](/reference/functions#regex-like-strings))
...
- `matches` (string|RegExp): Regular expression pattern the full URL must match. Use `/pattern/flags` syntax, or `regex("pattern", "flags")` when the pattern contains a comma or space (see [regex-like strings](/reference/functions#regex-like-strings))
