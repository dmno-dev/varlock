...
- **varlock as a local project dependency** (run via `pnpm exec`, `npm exec`, `bun x`, or package.json scripts): completion comes from your package manager's completion instead. See [Local project installs](#local-project-installs).
