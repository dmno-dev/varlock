...
- `allowedDomains` (string[]): List of allowed hosts, matched in full against the URL host (case-insensitive). A comma-separated string (`allowedDomains="a.com,b.com"`) is also accepted
