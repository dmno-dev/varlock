...
- `allowedDomains` (string[]): List of allowed hosts, matched in full against the URL host (case-insensitive). A bare string is treated as a single host; list two or more as an array
