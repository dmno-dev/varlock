---
title: Effect Plugin
description: Generate Effect Config modules from your Varlock environment schema
---
...
| `auto`, `filter`, `executeWhenImported` | Shared code generation options. See the [code generation guide](/guides/code-generation/). |
