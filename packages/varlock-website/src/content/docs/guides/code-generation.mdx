...
The [Effect plugin](/plugins/effect/) generates an Effect 4 Config module with typed values,
optional fields, and redacted secrets:
...
Install `@varlock/effect-plugin` and `effect@4.0.0-rc.112` first. See the
