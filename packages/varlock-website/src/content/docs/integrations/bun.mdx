...
For the most part, Varlock works with Bun the same way it works with Node.js, and other JavaScript integrations work the same way.
...
Do not do this if using a framework integration, as those integrations watch your `.env` files to trigger live-reloading.
:::