...
- [#1112](https://github.com/dmno-dev/varlock/pull/1112)  *(minor)*
...
- [#1124](https://github.com/dmno-dev/varlock/pull/1124)  *(minor)*
...
- [#1108](https://github.com/dmno-dev/varlock/pull/1108)  *(patch)*
...
- [#1107](https://github.com/dmno-dev/varlock/pull/1107)  *(patch)*
...
- [#1110](https://github.com/dmno-dev/varlock/pull/1110)  *(patch)*
...
- [#1109](https://github.com/dmno-dev/varlock/pull/1109)  *(patch)*
...
- [#1120](https://github.com/dmno-dev/varlock/pull/1120)  *(patch)*
...
- [#1121](https://github.com/dmno-dev/varlock/pull/1121)  *(patch)*
...
- [#1068](https://github.com/dmno-dev/varlock/pull/1068)  *(minor)*
...
- [#1082](https://github.com/dmno-dev/varlock/pull/1082)  *(minor)* - New `domainFromUrl()` function to extract the host from a URL, and a new `allowIpV6` option on the `domain` type
- [#1075](https://github.com/dmno-dev/varlock/pull/1075)  *(minor)* Thanks [@DavideCarvalho](https://github.com/DavideCarvalho)!
...
- [#1072](https://github.com/dmno-dev/varlock/pull/1072)  *(patch)* - Report loading/parse errors before resolving values, instead of crashing with `expected dataType to be set`
- [#1079](https://github.com/dmno-dev/varlock/pull/1079)  *(patch)*
...
- [#986](https://github.com/dmno-dev/varlock/pull/986)  *(patch)* Thanks [@jdalton](https://github.com/jdalton)!
...
- [#984](https://github.com/dmno-dev/varlock/pull/984)  *(patch)*
