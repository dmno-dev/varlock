...
:::tip[Full Turbopack support]
Both Webpack and [Turbopack](https://nextjs.org/docs/app/api-reference/turbopack) are fully supported, including all security features like leak detection, log redaction, and sourcemap scrubbing.
:::
