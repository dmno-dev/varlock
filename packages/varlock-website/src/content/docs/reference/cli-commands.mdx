...
:::note
You can also temporarily opt out by setting the `PH_OPT_OUT=true` environment variable. See the [analytics guide](/docs/guides/analytics) for more information about our analytics and privacy practices.
:::
