...
import { commandSpec as keysCommandSpec } from './commands/keys.command';
...
subCommands.set('keys', buildLazyCommand(keysCommandSpec, async () => await import('./commands/keys.command')));
