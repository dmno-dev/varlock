      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            badge: 'new',
            items: [
              { label: 'Overview', slug: 'guides/sandboxing' },
              { label: 'Minimal', slug: 'guides/sandboxing/minimal' },
              { label: 'Fence', slug: 'guides/sandboxing/fence' },
              { label: 'yolobox', slug: 'guides/sandboxing/yolobox' },
              { label: 'Agent Safehouse', slug: 'guides/sandboxing/agent-safehouse' },
              { label: 'bubblewrap', slug: 'guides/sandboxing/bubblewrap' },
              { label: 'MXC (Windows)', slug: 'guides/sandboxing/mxc' },
            ],
          },
        ],
      },
